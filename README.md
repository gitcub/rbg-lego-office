# RBG Office Lego Assembly Instructions

1. Browse to the PDF
2. Click the "Raw" button to download the file
3. Visit my [shopping list](http://rstephens.me/?p=56) if you haven't already
3. Have fun!
